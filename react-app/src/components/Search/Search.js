  ...
  return (
    <div>
      {searchResults.artist?.length ? (
        <>
          <h1>Songs with artists that match your search:</h1>
      ...
      {searchResults.genre.length ? (
        <>
          <h1>Songs with genres that match your search:</h1>
          <Carousel
            responsive={responsive}
            infinite={true}
            autoPlaySpeed={10000000}
      ...
      {searchResults.title?.length ? (
        <>
          <h1>Song titles that match your search:</h1>
          <Carousel
            responsive={responsive}
            infinite={true}
            autoPlaySpeed={10000000}
      ...
      {searchResults.playlist?.length ? (
        <>
          <h1>Playlist titles that match your search:</h1>
          <Carousel
            responsive={responsive}
            infinite={true}
            autoPlaySpeed={10000000}
